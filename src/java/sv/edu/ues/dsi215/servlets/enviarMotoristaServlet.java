 ...
 */
@WebServlet(name = "enviarMotoristaServlet", urlPatterns = {"/enviarMotoristaServlet"})
public class enviarMotoristaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("ModificarMotorista.jsp").forward(request, response);
