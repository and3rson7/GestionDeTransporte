 ...
 * @author IDANIA
 */
public class CorrelativoBitacoraActividades extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!connection.isClosed()) {
                sql = "SELECT MAX(correlativo) AS maxC FROM bitacoraactividades";
            }
            ...
            if(rs.getString("maxC") != null){
                ...
                correlativo = "BA" + String.valueOf(valor);
            }else{
                correlativo = "BA100001";
            }
            
            connection.close();
            
            request.getSession().setAttribute("correlativo", correlativo);
            response.sendRedirect("BitacoraActividades.jsp");
        } catch(Exception e){
