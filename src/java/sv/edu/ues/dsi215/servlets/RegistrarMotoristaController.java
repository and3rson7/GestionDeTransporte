 ...
 * @author Arnoldo
 */
public class RegistrarMotoristaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!connection.isClosed()) { 
                sql = "INSERT INTO motorista " + "VALUES" + " ('" + licencia + "','" + nombres + "','" + apellidos
                        + "','" + dui + "','" + telefono + "','" + direccion + "','" + sexo + "','" + fecha
                        + "','" + estado + "')";
            }
            ...
            response.sendRedirect("RegistrarMotorista.jsp");
