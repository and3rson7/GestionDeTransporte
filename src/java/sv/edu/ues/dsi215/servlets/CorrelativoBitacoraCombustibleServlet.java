 ...
 * @author anderson
 */
public class CorrelativoBitacoraCombustibleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(rs.getString("maxC") != null){
                ...
                correlativo = "BC" + String.valueOf(valor);
            }else{
                correlativo = "BC100001";
            }
            
            connection.close();
            
            request.getSession().setAttribute("correlativo", correlativo);
            response.sendRedirect("RegistrarBitacoraCombustible.jsp");
        } catch(Exception e){
