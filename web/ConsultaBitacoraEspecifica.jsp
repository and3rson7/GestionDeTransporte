...
ResultSet tabla = null;
 ...
 Class.forName("com.mysql.jdbc.Driver").newInstance();
     ...
     %>
     <strong><p style="margin-left: 120px; font-size:20px"> Actividades de Bitacora: 
             <%= request.getParameter("correlativo")%></p></strong><br>
<table align=center>
<TR><td bgcolor=#D8D8D8>CODIGO</td>
    ...
    <td bgcolor=#D8D8D8>Opciones</td></TR>
<%
while(tabla.next()) {
...
out.println("<TD>"+"<a href=DeleteActividad.jsp?numero="+tabla.getString(1)+">"+"Eliminar"+"</a>"+"</TD>");
