<%-- 
    Document   : RepMantenimiento
    Created on : 11-29-2013, 04:24:21 PM
    Author     : IDANIA
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            File reportFile = new File(application.getRealPath("reportes\\Mantenimiento.jasper"));//your report_name.jasper file
