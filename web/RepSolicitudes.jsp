<%-- 
    Document   : RepSolicitudes
    Created on : 11-29-2013, 04:24:56 PM
    Author     : IDANIA
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            File reportFile = new File(application.getRealPath("reportes\\Solicitudes.jasper"));//your report_name.jasper file
