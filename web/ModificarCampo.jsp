...
<table width="575" height="109" border="0"align="center">
  ...
  <tr>
    <td><div align="center">MODIFICAR REGISTRO DE MOTORISTA</div></td>
  </tr>
        ...
        <center>
           ...
           <form action="ActualizarCampo.jsp" method="post" name="FormModificar">
            <table align="center">
                <tr>
            ...
            <p>
                <input type="submit" value="Modificar"/> 
                    ...
                    <center><form action="ModificarMotorista.jsp"><p><input type="submit" value="Cancelar"></p></form></center>
