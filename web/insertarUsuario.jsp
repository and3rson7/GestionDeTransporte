...
<br><center><p style="font-size: 25px"><strong>REGISTRAR SOLICITUDES DE TRANSPORTE</strong></p></center><br><br>
    ...
    <tr>
      ...
      <label align="left"> 
          ...
          <input type="text" maxlength="100" name="para" class="form-control" value="Nelson Marroquin" align="left" onkeypress="return soloLetras(event)"/> 
    ...
    <tr>
      ...
      <td><label> 
        <input type="text" maxlength="100" class="form-control" name="de" required onkeypress="return soloLetras(event)"/> 
      </label></td> 
      <td>&nbsp;</td> 
    </tr> 
    <tr>
      ...
      <td>
          <div><input name="fecha" type="text" class="form-control" readonly="true" value="<%= fecha_actual%>"   /></div> 
      </td>
    ...
    <tr>
      ...
      <td><label>
        <input type="text" maxlength="250" name="actividad" class="form-control" onkeypress="return LetrasYnumeros(event)"/>
      </label></td>
    ...
    <tr>
      ...
      <td><label>
        <input type="text" maxlength="250" class="form-control" name="lugar" onkeypress="return LetrasYnumeros(event)"/>
      </label></td>
    </tr> 
        <tr>
         <th width="264" height="48" scope="row"><div align="left">Tipo de Unidad Solicitada</div></th>
        <td> <select class="form-control" name="tipoUnidad">
       ...
       <tr>
         ...
         <td><input align="left" size="5" type="text" class="form-control" maxlength="1" name="horaAprox" onkeypress="return soloNumeros(event)"/> 
  ...
  <tr>
    <td width="10"></td>
    <td width="67"><input type="submit" class="btn btn-success" value="Guardar" align="center" onclick="valida_envia()"/>
