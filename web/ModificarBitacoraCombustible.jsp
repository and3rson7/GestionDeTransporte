...
<html>
  <head>
    <title>Modificar Bitácora de Combustible</title>
  ...
  <body>
    ...
    <div class="container">
        <div class="panel panel-warning">
            ...
            <div class="panel-heading" style="text-align: center;">Modificar Bitácora de Combustible</div>
            <div class="panel-body">
                <form class="form-inline" id="modificar_bitacora_combustible" method="post" action="ModificarBitacoraCombustibleController">
                    ...
                    <input type="text" name="gasolinera" id="gasolinera" class="form-control" style="width: 600px; margin-left: 10px; margin-right: 10px;" maxlength="50" value="<jsp:getProperty name="bitacoracombustible" property="gasolinera" />" required />
                    </div>
