  ...
  <body>
    ...
    <div class="container">
        <div class="panel panel-warning">
            ...
            <div class="panel-heading" style="text-align: center;">Modificar Unidad de Transporte</div>
            <div class="panel-body">
                <form class="form-horizontal" role="form" id="modificar_unidad" method="post" action="ModificarUnidadController">
                    ...
                    <center>
                        ...
                        <input type="button" class="btn btn-danger" value="Cancelar" onclick="location.href='ControladorConsultaUnidad.jsp'">
                    </center>
                </form>
            </div>
        </div>
